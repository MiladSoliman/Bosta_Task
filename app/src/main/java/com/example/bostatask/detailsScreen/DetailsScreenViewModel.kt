...
/**
 * DetailsScreenViewModel class that responsible for specific album photos
 * @param getAlbumsPhotosUseCase The use case to get selected album photos from remote data source
 */
@HiltViewModel
